...
git clone --depth=1 https://github.com/mvaisakh/gcc-arm64.git  prebuilts/gcc/linux-x86/aarch64/arm64-gcc
git clone --depth=1 https://github.com/mvaisakh/gcc-arm.git  prebuilts/gcc/linux-x86/aarch64/arm32-gcc
